...
class GhanaModelFlow(FlowSpec):
    ...
    inverters = Parameter("inverters", help="Number of inverters", default=4)
    ...
    def start(self):
        ...
        self.our_load_profile = np.loadtxt(StringIO(self.load_profile), skiprows=1)
    ...
    def execute_pvmodel(self):
        ...
        pvmodel.SystemDesign.system_capacity = (
            mod_power_rating * 4 * self.modules_per_string * self.strings
        )
        ...
        self.uptime_percent = self.uptime_hours / (
            365 * 24 * 25
        )  # percent uptime for 25 years
